...
const CASES = {
  ...
  eczemawise: {
    ...
    name: "EczemaWise",
    title: "EczemaWise",
    tagline: "A symptom-tracking companion that brought 18,000 new users to the National Eczema Association.",
  ...
  origin: {
    ...
    sections: [
      ...
      { k: "text", h: "Focus-group findings", p: [
        ...
        "I ran a focus group, using a set of questions to spark dialogue about what participants valued most when reviewing and investing in REIT blocks. I then used that to organize the visual hierarchy of each block." ] },
